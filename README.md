...
## Stretch 3:
80% code coverage of `lib.js` with GOOD (not pointless) unit tests.
...
* As a developer, when I send my collection via POST request to the POST API: https://lit-fortress-6467.herokuapp.com/post , I receive and log a response to the console. # playlist-assessment
